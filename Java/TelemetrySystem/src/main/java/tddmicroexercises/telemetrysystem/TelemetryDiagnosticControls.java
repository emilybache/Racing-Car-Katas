...
public class TelemetryDiagnosticControls
{
    ...
    private TransmissionService telemetryTransmissionService;
    private Connection telemetryConnectionService;
    private String diagnosticInfo = "";

        public TelemetryDiagnosticControls(TransmissionService telemetryTransmissionService, Connection telemetryConnectionService)
        {
