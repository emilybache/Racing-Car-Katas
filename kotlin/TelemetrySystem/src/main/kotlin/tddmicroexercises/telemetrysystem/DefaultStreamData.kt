...
class DefaultStreamData(
    private val connectionEventsSimulator: Random
) : StreamData {
    private var diagnosticMessageResult: String = ""

    override fun getDiagnosticMessageResult(): String = diagnosticMessageResult
    ...
    companion object {
        const val DIAGNOSTIC_MESSAGE = "AT#UD"
    }
}
